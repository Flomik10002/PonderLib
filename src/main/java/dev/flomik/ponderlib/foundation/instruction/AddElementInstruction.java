...
public final class AddElementInstruction<E extends PonderElement> extends PonderInstruction {
    private final Supplier<? extends E> factory;
    private final ElementLink<E> link;

    public AddElementInstruction(Supplier<? extends E> factory, ElementLink<E> link) {
    ...
    @Override public void tick(PonderScene scene) {
        E element = factory.get();
        if (element == null) throw new IllegalStateException("Custom Ponder element factory returned null");
